...
rem EDIT LGU names for use in file names (small-caps only)
...
rem osmconvert -v %INPUT% -B=%BOUND2% -o=%OUTPUT2%
osmconvert -v --complex-ways --complete-ways %INPUT% -B=%BOUND2% -o=%OUTPUT2%
popd
popd